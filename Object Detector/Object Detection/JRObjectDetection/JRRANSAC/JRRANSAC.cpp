...
void RANSAC::listConfidentPlanes() {
	...
	for (Plane const& plane : confidentPlanes) {
		cout << "\tPlane " << count++ << " : A:" << plane.a << " B:" << plane.b << " C:" << plane.b << " D:" << plane.d << endl;
	}
}
...
void RANSAC::performRANSAC() {
	...
	plane_confidences.erase(plane_confidences.begin(), plane_confidences.end());
